...
const Navbar = (props)=>{
    ...
    return(
        <div className="w-16 sm:w-40   h-[100vh]  fixed top-[50%] translate-y-[-50%] bg-black/50 backdrop-blur-[3px] backdrop-saturate-100 rounded-[5px] flex flex-col sm:px-0 px-1">
            ...
            <div className="sm:flex flex-col text-white/80 space-y-0 hidden ">
                    <div className=" text-center text-xl font-[600]">PAREEKSHITH</div> 
                     <div className="text-center text-lg text-white/90">Portfolio</div>
                </div>
            <hr className="text-gray-900 border-1 w-[100%]"/>
            
            {/* Links */}
            <ul className="justify-center flex flex-col h-screen pb-2">
               <a href = '#home' onClick={()=>setActive('home')} className=" flex text-white/80 items-center space-x-2  hover:bg-white/10   hover:cursor-pointer w-[90%] mx-auto rounded-[15px] p-2 group  relative">
              
                   <FontAwesomeIcon className={`text-xl w-7 group-hover:text-white ${active == 'home' ? 'text-amber-400' : ""}`} icon ={faHome} id='home'/>
               ...
               <a href = '#about' onClick={()=>setActive('about')} className="mt-4 flex text-white/80 items-center space-x-2  hover:bg-white/10   hover:cursor-pointer w-[90%] mx-auto rounded-[15px] p-2 group relative">
                   <FontAwesomeIcon className={`text-xl w-7 group-hover:text-white ${active == 'about' ? 'text-amber-400' : ""}`} icon ={faUser} id ='about'/>
               ...
               <a href = '#projects' onClick={()=>setActive('projects')} className=" mt-4 flex text-white/80 items-center space-x-2  hover:bg-white/10   hover:cursor-pointer w-[90%] mx-auto rounded-[15px] p-2 group relative">
                   <FontAwesomeIcon className={`text-xl w-7 group-hover:text-white ${active == 'projects' ? 'text-amber-400' : ""}`} icon ={faLightbulb} id = 'contactme'/>
                    <span className="text-sm group-hover:text-white font-[800] hidden sm:inline ">Projects</span>
               ...
               <a href = '#contact' onClick={()=>setActive('contact')} className=" mt-4 flex text-white/80 items-center space-x-2  hover:bg-white/10   hover:cursor-pointer w-[90%] mx-auto rounded-[15px] p-2 group relative">
                   <FontAwesomeIcon className={`text-xl w-7 group-hover:text-white ${active == 'contact' ? 'text-amber-400' : ""}`} icon ={faEnvelope} id = 'contactme'/>
                    <span className="text-sm group-hover:text-white font-[800] hidden sm:inline ">Contact</span>
